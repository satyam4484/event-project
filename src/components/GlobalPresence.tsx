    ...
    <section ref={ref} className="relative bg-ink-975 py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className={`reveal ${visible ? 'is-visible' : ''} text-center`}>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base font-light text-ink-100/60">
        ...
        {/* World Map */}
        <div className={`reveal ${visible ? 'is-visible' : ''} relative mx-auto mt-16 max-w-4xl`}>
          <div className="relative aspect-[1009/666] overflow-hidden rounded-2xl glass p-4">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {countries.map((country) => (
              <span
                key={country.name}
                className="flex items-center gap-2 rounded-full glass px-4 py-2 text-sm font-medium text-ink-100/70 transition-all duration-300 hover:border-gold-400/30 hover:text-gold-200"
              >
